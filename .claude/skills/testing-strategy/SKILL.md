...
2. Split tests by layer: domain, application, infrastructure, UI/API, and async.
...
8. Identify edge cases and misuse cases.
...
List tests by layer: domain, application, infrastructure, UI/API, and async.
