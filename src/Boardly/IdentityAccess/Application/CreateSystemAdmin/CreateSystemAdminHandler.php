...
final readonly class CreateSystemAdminHandler
{
    ...
    public function __invoke(CreateSystemAdminCommand $command): CreateSystemAdminResult
    {
        return $this->transactional->transactional(
            function () use ($command): CreateSystemAdminResult {
                ...
                $domainResult = Account::createSystemAdmin($id, $email, $passwordHash, $name, $now);
